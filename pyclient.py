...
while not shutdownClient:
    ...
    while True:
        ...
        if buf is not None:
            d.state.setFromMsg(buf)  # parse the buffer
            print("Car State Data:")
            print(f"  SpeedX: {d.state.getSpeedX()}")
            print(f"  SpeedY: {d.state.getSpeedY()}")
            print(f"  SpeedZ: {d.state.getSpeedZ()}")
            print(f"  Angle: {d.state.getAngle()}")
            print(f"  RPM: {d.state.getRpm()}")
            print(f"  Gear: {d.state.getGear()}")
            print(f"  TrackPos: {d.state.getTrackPos()}")
            print(f"  Fuel: {d.state.getFuel()}")
